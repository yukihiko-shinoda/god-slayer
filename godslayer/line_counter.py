...
class LineCounter:
    ...
    def count(path_to_file: Path, encoding: str = "utf-8") -> int:
        ...
        - How to get the line count of a large file cheaply in Python - Stack Overflow
          https://stackoverflow.com/questions/845058/how-to-get-the-line-count-of-a-large-file-cheaply-in-python/850962#850962
        """
